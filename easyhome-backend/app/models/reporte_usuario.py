...
class Reporte_Usuario(Base):
    ...
    )  # pendiente, revisado, resuelto, desestimado
    ...
    proveedor_reportado = relationship(
        "Proveedor_Servicio", back_populates="reporte_usuario"
    )
